...
- 개인 Task에서는 원형 `완료/전체` 진행률과 목록을 핵심 정보 아래에 펼치고, Workspace 목록에서는 사용자가 요청할 때만 열어 여러 Task의 세로 밀도를 제어한다.
- 체크리스트 선택안과 실제 화면 근거는 [`task-checklist-2026-09-05`](../audits/task-checklist-2026-09-05/README.md)에 둔다.
