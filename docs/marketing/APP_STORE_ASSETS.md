...
Dooit Mobile을 앱 마켓, 소개 페이지, 발표 자료에 보여주기 위한 이미지와 문구 초안이다. 실제 스토어 제출 전에는 Google Play와 App Store의 최신 이미지 규격을 별도로 확인한다.
...
- 원본 화면의 최신 촬영일은 **2026-09-13**이며 상세 기준은 [`screenshots/README.md`](../screenshots/README.md)에 기록한다.
