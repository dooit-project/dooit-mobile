...
- [Task 체크리스트 선택안과 390×844 판정 (2026-09-05)](../audits/task-checklist-2026-09-05/README.md)
...
- 개인 체크리스트의 empty·CRUD·정렬은 확인했다. loading·API 오류·복구 캡처가 남았다.
...
- [UF-08 최신 캡처와 판정 (2026-08-26)](../audits/uf-08-settings-notifications-session-2026-08-26/README.md)
- [기존 설정 캡처](../screenshots/settings.png)

남은 캡처:

- Android·iOS 시스템 light·dark 전환
- 알림 미결정·허용·거부·설정 복귀·동기화 오류
- foreground·background·cold start 알림 선택
- 실제 401 session 만료, 계정 전환과 기존 route 복구
...
| Task·체크리스트    | 있음      | 있음 | 있음      | 일부      | 부족           | Workspace mock | 부족 | 보강 필요 |
