...
- `npm run validate`의 최신 기준선은 68 suites, 363 tests 통과다.
...
- [ ] staging·production API URL을 확정하고 `npm run check:backend-deployment`로 readiness와 실행 백엔드 commit 또는 image tag를 확인한다.
